...
echo "Running bwa..."
bwa aln -e 0 -o 0 /opt/database/HLA-I_II_CDS.fasta FASTQ > aln.sai
bwa sampe -o 1000 /opt/database/HLA-I_II_CDS.fasta aln_1.sai aln_2.sai FASTQ > SAMPLEID.aln.sam
### Predict HLA
echo "Predicting HLA..."
...
echo FASTQ1 > fastq.file

/opt/bin/TASR -f fastq.file -m 20 -k 20 -s /opt/database/HLA-I_II_CDS.fasta -i 1 -b TASRhla -w 1
